...
import 'package:flutter_interview_application/presentations/choose_account/choose_account_cubit.dart';
import 'package:flutter_interview_application/presentations/login/login_screen.dart';
...
class ChooseAccountScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ChooseAccountCubit(users),
      child: Scaffold(
        appBar: AppBar(
          title: FlutterLogo(
            size: 40,
