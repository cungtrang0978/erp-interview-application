...
import 'package:flutter_interview_application/features/sales_order/controllers/sale_order_detail_cubit.dart';
...
class _SaleOrderDetailScreenState extends State<SaleOrderDetailScreen> {
  final saleOrderDetailCubit = SaleOrderDetailCubit();
