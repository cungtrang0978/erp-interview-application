...
class _AddItemScreenState extends State<AddItemScreen> {
  ...
  Future<void> _loadProducts() async {
    ...
    _products = await RemoteDatabaseService.instance.getProducts();
  ...
  Future<void> _loadWarehouses() async {
    ...
    var allWarehouses = await RemoteDatabaseService.instance.getWarehouses();
    List<Warehouse> filteredWarehouses = [];

    for (var warehouse in allWarehouses) {
      Inventory? inventory = await RemoteDatabaseService.instance
  ...
  Future<void> _checkInventory() async {
    ...
    _inventory = await RemoteDatabaseService.instance.getInventoryByProductAndWarehouse(
